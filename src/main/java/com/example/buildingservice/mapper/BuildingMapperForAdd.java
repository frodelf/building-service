...
public interface BuildingMapperForAdd {
    ...
    default Building updateEntityFromDto(BuildingDtoForAdd buildingDtoForAdd, MinioServiceClient minioServiceClient, BuildingService buildingService) throws IOException {
